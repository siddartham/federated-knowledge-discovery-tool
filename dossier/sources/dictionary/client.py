...
Configured via env:
- DOSSIER_DICTIONARY_URL    base URL (default https://www.allacronyms.com);
                            unset/empty disables enrichment (client is a no-op).
- DOSSIER_DICTIONARY_DOMAIN category segment (default "computing"); empty appends
                            no segment, querying every field.
- DOSSIER_DICTIONARY_TOKEN  optional bearer token for the endpoint.
"""
...
class DictionaryClient:
    def __init__(
        ...
        # DEFAULT_DICTIONARY_URL/DOMAIN already fold in DOSSIER_DICTIONARY_URL/
        ...
        self._token = token or os.environ.get("DOSSIER_DICTIONARY_TOKEN")
