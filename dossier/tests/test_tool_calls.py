...
from dossier.engine.orchestrator.tool_provider import select_tools, select_tools_semantic
...
from dossier.sources.mcp import FakeMCPClient, MCPToolProvider, ToolContent, ToolSpec
