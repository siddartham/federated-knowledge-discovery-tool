"""A warm Columbo session for the UI: one browser + cache + registry kept alive
across chat turns (the `columbo interactive` pattern), so repeated questions
...
from columbo_py.cli.main import _build_registry
...
class WarmSession:
    ...
    async def start(self) -> None:
        ...
        self._fetcher = WebFetcher(self._browser, self._cache, EventEmitter("columbo-ui-session"))
