...
from columbo_py.engine.orchestrator.actions import _format_senses, execute_actions
...
def test_definitions_from_html_extracts_meaning_cells() -> None:
    ...
    from columbo_py.sources.dictionary.client import _definitions_from_response
...
def test_coerce_definitions_handles_list_dict_and_text() -> None:
    from columbo_py.sources.dictionary.client import _coerce_definitions
